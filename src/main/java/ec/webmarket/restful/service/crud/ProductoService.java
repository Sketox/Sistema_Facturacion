...
public class ProductoService extends GenericCrudServiceImpl<Producto, ProductoDTO> {
    ...
    public Producto mapToDomain(ProductoDTO dto) {
        ...
        if (dto.getNombre() == null || dto.getCodigo() == null || dto.getPrecioUnitario() == null || dto.getStock() == null) {
    ...
    public ProductoDTO createProducto(ProductoDTO dto) {
        ...
        if (dto.getCodigo() == null || dto.getNombre() == null || dto.getPrecioUnitario() == null || dto.getStock() == null) {
            throw new IllegalArgumentException("Todos los campos obligatorios deben estar llenos.");
        }
    ...
    public ProductoDTO updateProducto(Long id, ProductoDTO dto) {
        ...
        productoExistente.setCodigo(dto.getCodigo() != null ? dto.getCodigo() : productoExistente.getCodigo());
        ...
        productoExistente.setPrecioUnitario(dto.getPrecioUnitario() != null ? dto.getPrecioUnitario() : productoExistente.getPrecioUnitario());
